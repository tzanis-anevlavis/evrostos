...
\input{cmd/convert_property_to_invar}
...
\input{cmd/check_pslspec_bmc}
\input{cmd/check_pslspec_bmc_inc}
\input{cmd/check_pslspec_sbmc}
\input{cmd/check_pslspec_sbmc_inc}
...
\begin{nusmvVar} {pp\_cpp\_path}{\filename{stdin\_file}}{none}
\code{pp\_cpp\_path} is absoult or relative path to the preprocessor.
...
\begin{nusmvVar} {pp\_m4\_path}{\filename{stdin\_file}}{none}
\code{pp\_m4\_path} is absoult or relative path to the preprocessor.
If this value is set, preprocessor from the path will be invoked.
