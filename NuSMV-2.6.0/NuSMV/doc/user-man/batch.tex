...
-pre option. The user can set his own preprocessor by setting system
variables pp\_cpp\_path and pp\_m4\_path.}
...
\ \newline Sets the default value of environment variable 
