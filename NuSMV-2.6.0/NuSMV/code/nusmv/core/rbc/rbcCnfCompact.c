...
/*!
  \brief Data passing in compact cnf-DFS.

  Data passing in compact cnf-DFS.
*/
...
/*!
  ...
  Per-node data in compact cnf-DFS.
*/
...
static void CnfCompactLast(Rbc_t* f, char* cnfData, nusmv_ptrint sign)
{
  ...
  default:
    ErrorMgr_internal_error(errmgr, "rbcCnf: unexpected node %d\n", f->symbol);
    return;
  }
...
/*!
  ...
  \se clauses refers to the singleton clause set referring to the
  renamed clauses
*/
