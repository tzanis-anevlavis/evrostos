...
/*!
  ...
  \brief This is a hack, i.e. an auxiliary dummy file to make 'ar'
  work under Mac OS X.

  Under Mac OS X the source of libnusmv_la_SOURCES (in
...
void cinit_dummy_function_to_make_ar_work_under_mac_os_x_DO_NOT_USE_THIS_FUNCTION(void);
void cinit_dummy_function_to_make_ar_work_under_mac_os_x_DO_NOT_USE_THIS_FUNCTION(void)
{
}
