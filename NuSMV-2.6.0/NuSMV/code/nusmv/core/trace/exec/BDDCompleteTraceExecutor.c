...
/*!
  ...
  \brief Implementation of class 'BDDCompleteTraceExecutor'
...
/*!
  \brief The BDDCompleteTraceExecutor class virtual finalizer
...
/*!
  \brief Executes a trace on the given fsm using BDDs
