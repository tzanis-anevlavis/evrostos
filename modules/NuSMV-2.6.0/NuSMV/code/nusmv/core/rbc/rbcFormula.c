...
/*!
  \brief Calls several minimization rules.
  ...
  \se If RBC_ENABLE_LOCAL_MINIMIZATION_WITHOUT_BLOWUP is not 1:
               "a" is modified;
...
/*!
  \brief Gets the children of the given rbcs

  Gets the children only of the non-NIL passed rbcs between left
               or right and makes all the needed assertions

  \se To l1, l2, r1 and r2 are assigned the pointers of the children
...
/*!
  \brief The Biere/Brummayer asymm. contradiction (O2) reduction rule

  If the rule is satisfied, returns the false or true rbc, based
               on sign:
               (s)AND(AND(a,b),c) = (s)F
               if c = ~a.
...
/*!
  \brief The Biere/Brummayer idempotence (O2) reduction rule

  If the rule is satisfied, returns d, the parent of a and b:
...
/*!
  ...
  If the rule is satisfied, substitute d, the parent of a and b,
...
/*!
  \brief The Biere/Brummayer asymm. subsumption (O2) reduction rule

  If the rule is satisfied, return the passed rbc:
               (s)AND(~AND(a,b),c) = (s)c
               if a = ~c.
               The rule is applied in all its commutative variants.
...
/*!
  \brief The Biere/Brummayer idempotence (O4) reduction rule

  If the rule is satisfied, substitute e, the parent of c and d,
...
/*!
  \brief The Biere/Brummayer resolution (O3) reduction rule

  If the rule is satisfied, return the negation of one of the
               children passed:
...
/*!
  \brief The Biere/Brummayer symm. subsumption (O2) reduction rule

  If the rule is satisfied, returns e, the parent of c and d:
...
/*!
  \brief The Biere/Brummayer symm. substitution (O3) reduction rule

  If the rule is satisfied, substitute e, the parent of a and b,
               with the negation of one of its children.
                 (s)AND(e,AND(c,d)) =
...
/*!
  \brief Reduction (simplification) of rbcs.
